// I was having an hard time with this one so I looked up some solutions and took inspiration from them 
// I hate recursive things :(
...
dotted black bags contain no other bags.";
    ...
    assert_eq!(4, part1(&String::from(input)));
    }
}
